  ...
  lifecycle({
    ...
    <GoogleMap
     ...
     >
        ...
        <SSMMarkers mapObj={props.mapObj} ssmsent={props.ssmsent} fetchSRM={props.fetchSRM} onMount={props.onSsmMount} addLogs={props.addLogs} showNotifications={props.showNotifications} updatessm={props.updatessm}/>
    </GoogleMap>
));
